...
ALTER TABLE [Modulo]
	ADD CONSTRAINT [XPKModulo] PRIMARY KEY  NONCLUSTERED ([IdModulo] ASC,[IdEspecialidad]ASC ,[AÒo_Modulo]ASC)
go
...
ALTER TABLE [Modulo_Profesional]
	ADD CONSTRAINT [XPKModulo_Profesional] PRIMARY KEY  NONCLUSTERED ([IdModulo] ASC,[IdEspecialidad]ASC,[AÒo_Modulo]ASC)
go
...
ALTER TABLE [Modulo_Tranversal]
	ADD CONSTRAINT [XPKModuloTranversal] PRIMARY KEY  NONCLUSTERED ([IdModulo] ASC,[IdEspecialidad]ASC,[AÒo_Modulo]ASC)
go
...
ALTER TABLE [Notas]
	ADD CONSTRAINT [XPKNotas] PRIMARY KEY  NONCLUSTERED ([IdaLUMNO] ASC,[IdUndDidac] ASC,[IdSemestre],[IdEspecialidad] asc,[AÒo_Modulo]ASC, [IDTURNO]ASC, [IDCICLO] ASC)
go
...
ALTER TABLE [Notas]
	ADD CONSTRAINT [R_72] FOREIGN KEY ([IdUndDidac],[IdModulo],[IdEspecialidad],[AÒo_Modulo]) REFERENCES [UndDidactica]([IdUndDidac],[IdModulo],[IdEspecialidad],[AÒo_Modulo]) 
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [UndDidactica]
	ADD CONSTRAINT [R_62] FOREIGN KEY ([IdModulo],[IdEspecialidad],[AÒo_Modulo]) REFERENCES [Modulo]([IdModulo],[IdEspecialidad],[AÒo_Modulo])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
