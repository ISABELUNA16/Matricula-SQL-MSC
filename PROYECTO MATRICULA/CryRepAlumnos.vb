...
Public Class CryRepAlumnos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CryRepAlumnos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRepAlumnos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRepAlumnos = New CryRepAlumnos()
        rpt.Site = Me.Site
        Return rpt
    End Function
