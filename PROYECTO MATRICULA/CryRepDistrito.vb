...
Public Class CryRepDistrito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CryRepDistrito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRepDistrito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRepDistrito = New CryRepDistrito()
        rpt.Site = Me.Site
        Return rpt
    End Function
